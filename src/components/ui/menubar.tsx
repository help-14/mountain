...
const Menubar = <T extends ValidComponent = "div">(
  ...
  return (
    <MenubarPrimitive.Root
      class={cn("flex h-10 items-center space-x-1 rounded-md p-1", local.class)}
      {...others}
    />
  );
};
  ...
  return (
    <MenubarPrimitive.Portal>
      <MenubarPrimitive.Content
        class={cn(
          "z-50 min-w-48 origin-[var(--kb-menu-content-transform-origin)] animate-content-hide overflow-hidden rounded-md bg-popover p-1 text-popover-foreground shadow-md data-[expanded]:animate-content-show",
          local.class
        )}
        {...others}
      />
...
const MenubarCheckboxItem = <T extends ValidComponent = "div">(
  ...
  return (
    <MenubarPrimitive.CheckboxItem
      class={cn(
        "relative flex cursor-default select-none items-center rounded-sm py-1.5 pl-2 pr-2 text-sm outline-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
        local.class
      )}
      {...others}
    >
      <span
        class="absolute right-2 flex size-3.5 items-center justify-center border-1 rounded-sm"
...
const MenubarSeparator = <T extends ValidComponent = "hr">(
  ...
  return (
    <MenubarPrimitive.Separator
      class={cn("-mx-1 my-1 h-px", local.class)}
      {...others}
    />
  );
};
