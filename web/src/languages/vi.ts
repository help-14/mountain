export const vi = {
  ...
  header: {
    ...
    select: {
      ...
      clickBrowse: "Click để mở",
      outsideDeselect: "Click bên ngoài để bỏ chọn tất cả",
    },
    about: {
      title: "Giới thiệu",
      shortcuts: "Phím tắt",
  ...
  upload: {
    ...
    completed: "Tải lên hoàn tất",
    completedMessage: "Hoàn thành tải lên {0} file!",
  },
  modals: {
    close: "Đóng",
    delete: {
      title: "Xoá dữ liệu",
      description:
        "Những dữ liệu này sẽ bị xoá vĩnh viễn, bạn có chắn chắn không homie?",
      submit: "Xoá",
    },
    newFile: {
      title: "Tạo file mới",
    ...
    compress: {
      fileName: "Tên file sau khi nén",
      format: "Định dạng nén",
      submit: "Nén lại",
    },
  },
  tasks: {
    none: "Không có nhiệm vụ nào!",
    rename: "Đổi tên:",
    copy: "Sao chép từ:",
    move: "Di chuyển từ:",
    delete: "Xoá tất cả tại:",
    compress: "Nén lại:",
  },
};
